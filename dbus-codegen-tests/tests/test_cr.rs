...
impl policykit_cr::DBusProperties for () {
    fn get(&mut self, interfacename: String, propertyname: String) -> Result<dbus::arg::Variant<Box<dyn dbus::arg::RefArg>>, dbus::MethodErr> {
        assert_eq!(interfacename, "Interface.Name");
        assert_eq!(propertyname, "Property.Name");
        Ok(::dbus::arg::Variant(Box::new(5u8)))
    }

    fn get_all(&mut self, _interfacename: String) ->
    Result<::std::collections::HashMap<String, dbus::arg::Variant<Box<dyn dbus::arg::RefArg>>>, dbus::MethodErr> { unimplemented!() }

    fn set(&mut self, _interfacename: String, _propertyname: String, value: dbus::arg::Variant<Box<dyn dbus::arg::RefArg>>) -> Result<(), dbus::MethodErr> {
