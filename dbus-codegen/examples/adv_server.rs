...
//
// Usually you would put imported code in a separate .rs file.
//
// === Imported code start ===
...
pub trait ComExampleDbusRsDevice {
    type Err;
...
impl<'a, C: ::std::ops::Deref<Target=dbus::Connection>> ComExampleDbusRsDevice for dbus::ConnPath<'a, C> {
    type Err = dbus::Error;
...
pub fn com_example_dbus_rs_device_server<F, T, D>(factory: &tree::Factory<tree::MTFn<D>, D>, data: D::Interface, f: F) -> tree::Interface<tree::MTFn<D>, D>
where
    D: tree::DataType,
    D::Method: Default,
    D::Property: Default,
    T: ComExampleDbusRsDevice<Err=tree::MethodErr>,
...
pub struct ComExampleDbusRsDeviceCheckComplete {
}

impl dbus::SignalArgs for ComExampleDbusRsDeviceCheckComplete {
...
use dbus::{Connection, BusType, Path};
...
impl ComExampleDbusRsDevice for Device {
...
fn create_iface() -> Interface<MTFn<TData>, TData> {
    ...
    com_example_dbus_rs_device_server(&f, (), |m| {
...
fn run() -> Result<(), Box<std::error::Error>> {
    ...
    loop {
        ...
        if let Ok(idx) = check_complete_r.try_recv() {
            ...
            let sig = ComExampleDbusRsDeviceCheckComplete {};
            use dbus::SignalArgs;
